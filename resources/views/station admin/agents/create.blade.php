    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('agents.index') }}">Police officers</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Police officers</h3>
                        </div>
                        <!-- /.box-header -->

                        <!-- form start -->
                        <form role="form" method="post" action="{{ route('agents.store') }}">
                            {{csrf_field()}}
                            <div class="box-body">
                            ...
                            <div class="box-footer">
                                ...
                                <a class="btn btn-warning" href="{{ route('agents.index') }}">Back</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.box -->
