                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-offset-3 col-md-6">
                                    <div class="form-group">
                                        <img src="{{ Storage::url('public/files/cases/noimage.png') }}"  alt="User Image" id="preview" height="100px" width="100px" onchange="previewImage(this)">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="url" class="form-control" id="location" name="url" placeholder="Partner site url">
                                    </div>
