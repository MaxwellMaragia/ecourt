    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('court_admins.index') }}">court admins</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">court admins</h3>
                        </div>
                        <!-- /.box-header -->

                        <!-- form start -->
                        <form role="form" method="post" action="{{ route('court_admins.store') }}">
                            {{csrf_field()}}
                            <div class="box-body">
                                ...
                                <div class="col-md-offset-3 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="court" class="form-control" required="required">
                            ...
                            <div class="box-footer">
                                ...
                                <a class="btn btn-warning" href="{{ route('court_admins.index') }}">Back</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.box -->
