                            ...
                            @foreach($cases as $case)
                               @if($case->magistrate != '')
                                   <tr>
                                       ...
                                       <td>
                                           <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="{{ url('viewcase',$case->id) }}" class="badge bg-light-blue " disabled><i class="fa fa-eye" aria-hidden="true"></i></a>
                                       </td>
                                   </tr>
                               @endif
                            @endforeach
